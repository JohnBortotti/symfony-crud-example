 ...
 */
final class Version20220120200031 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_B723AF33E7927C74 ON students (email)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_B723AF33E7927C74 ON students');
    }
}
